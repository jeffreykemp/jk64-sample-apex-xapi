...
wwv_flow_api.import_begin (
 p_version_yyyy_mm_dd=>'2015.07.01'
,p_release=>'5.1.0.00.16'
...
--   Date and Time:   03:22 Thursday June 30, 2016
--   Exported By:     JEFFREY.KEMP@JK64.COM
--   Flashback:       0
--   Export Type:     Application Export
--   Version:         5.1.0.00.16
--   Instance ID:     186039614142224
--
...
,p_authentication_id=>wwv_flow_api.id(60530091261864787)
...
,p_last_upd_yyyymmddhh24miss=>'20160630031902'
...
,p_security_scheme=>wwv_flow_api.id(62246739341844416)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'5,6,10'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(68527293133725213)
,p_list_item_display_sequence=>22
,p_list_item_link_text=>'Add Host'
,p_list_item_link_target=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.:6:::'
,p_list_item_icon=>'fa-plus'
,p_parent_list_item_id=>wwv_flow_api.id(37802424942935278)
,p_security_scheme=>wwv_flow_api.id(62246739341844416)
,p_list_item_current_type=>'NEVER'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(67682584338742300)
...
,p_list_item_link_text=>'Edit - Tabular Form'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4018036093009570)
,p_list_item_display_sequence=>36
,p_list_item_link_text=>'Edit - Interactive Grid'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3765599944613862)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Edit - Tabular Form'
,p_list_item_link_target=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:RP,7:::'
,p_list_item_icon=>'fa-table'
,p_parent_list_item_id=>wwv_flow_api.id(37802181009934168)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3765931230615790)
...
,p_attribute_01=>'RETURN :APP_USER IN (''JEFF'',''DEMO'');'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(469915319925536)
,p_parent_id=>wwv_flow_api.id(64759372604907622)
,p_short_name=>'Event Types IG'
,p_link=>'f?p=&APP_ID.:15:&SESSION.'
,p_page_id=>15
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(4024606568009595)
,p_parent_id=>wwv_flow_api.id(61172716614993888)
,p_short_name=>'Venues IG'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(60167119744877027)
,p_parent_id=>wwv_flow_api.id(66954968908165628)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(61204422446195099)
,p_parent_id=>wwv_flow_api.id(61172716614993888)
,p_short_name=>'Grid Edit'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(64760064583907628)
,p_parent_id=>wwv_flow_api.id(64759372604907622)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(66955672359165630)
,p_parent_id=>wwv_flow_api.id(66954968908165628)
,p_short_name=>'Host'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(66990480447120737)
,p_parent_id=>wwv_flow_api.id(64759372604907622)
,p_short_name=>'Grid Edit'
...
'      <button class="t-Button t-Button--icon t-Button--header t-Button--headerTree" id="t_Button_navControl" type="button"><span class="t-Icon fa fa-bars" aria-hidden="true"></span></button>',
'    </div>',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1056976244659566)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1057491595659566)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1057949099659566)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058438395659567)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058941914659567)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1059515488659567)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1060014094659568)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
,p_name=>'Page Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1060460390659568)
,p_page_template_id=>wwv_flow_api.id(37710474548902429)
...
'    <button class="t-Button t-Button--icon t-Button--header t-Button--headerRight" id="t_Button_rightControlButton" type="button"><span class="t-Icon fa fa-bars" aria-hidden="true"></span></button>',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1064922117659577)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065347853659577)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065878371659578)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1066337090659578)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1066879320659578)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1067373742659578)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1067853712659579)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068367298659579)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068866912659579)
,p_page_template_id=>wwv_flow_api.id(37713083105902435)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1070469349659580)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1070938968659581)
,p_page_template_id=>wwv_flow_api.id(37715964884902436)
,p_name=>'Body Header'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075431742659584)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075839861659585)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1076350489659585)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Master Detail'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1076863807659585)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1077415651659586)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1077865666659586)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1078394175659586)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1078843822659587)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079401860659587)
,p_page_template_id=>wwv_flow_api.id(37716744210902437)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1083022788659590)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1083467635659590)
,p_page_template_id=>wwv_flow_api.id(37719686823902441)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1083980823659591)
,p_page_template_id=>wwv_flow_api.id(37719686823902441)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1084438912659591)
,p_page_template_id=>wwv_flow_api.id(37719686823902441)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1085028681659591)
,p_page_template_id=>wwv_flow_api.id(37719686823902441)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1085523738659592)
,p_page_template_id=>wwv_flow_api.id(37719686823902441)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1085955205659592)
,p_page_template_id=>wwv_flow_api.id(37719686823902441)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1087952300659594)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1088491748659594)
,p_page_template_id=>wwv_flow_api.id(37721993541902443)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1088952426659594)
,p_page_template_id=>wwv_flow_api.id(37721993541902443)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1093588708659703)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1094037377659704)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1094596592659704)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1095054948659704)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1095558539659704)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1096101529659705)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1096578755659705)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1097113124659705)
,p_page_template_id=>wwv_flow_api.id(37723017570902444)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1100729880659708)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1101151610659709)
,p_page_template_id=>wwv_flow_api.id(37725602709902445)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1101675459659709)
,p_page_template_id=>wwv_flow_api.id(37725602709902445)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1102169030659710)
,p_page_template_id=>wwv_flow_api.id(37725602709902445)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1102684813659710)
,p_page_template_id=>wwv_flow_api.id(37725602709902445)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1103205096659710)
,p_page_template_id=>wwv_flow_api.id(37725602709902445)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1103682740659710)
,p_page_template_id=>wwv_flow_api.id(37725602709902445)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1105700684659712)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1106228782659713)
,p_page_template_id=>wwv_flow_api.id(37727914031902447)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1106686649659713)
,p_page_template_id=>wwv_flow_api.id(37727914031902447)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1108597183659741)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1116125685659782)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1116632482659783)
,p_plug_template_id=>wwv_flow_api.id(37732339428902452)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1120580111659814)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1121126899659814)
,p_plug_template_id=>wwv_flow_api.id(37734319759902454)
,p_name=>'Slides'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1136376582659863)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1136842652659863)
,p_plug_template_id=>wwv_flow_api.id(37741369186902460)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1147983663659902)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1153069470659925)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1158449892659993)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1160111854659995)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1160552218659995)
,p_plug_template_id=>wwv_flow_api.id(37749289366902466)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1173705191660037)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1174208644660038)
,p_plug_template_id=>wwv_flow_api.id(37753699237902469)
,p_name=>'Tabs'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(1180406848660107)
...
'      <div class="t-Card-icon u-color"><span class="t-Icon #ICON_CSS_CLASSES#"><span class="t-Card-initials" role="presentation">#A03#</span></span></div>',
...
'      <div class="t-Card-icon u-color"><span class="t-Icon #CARD_ICON#"><span class="t-Card-initials" role="presentation">#CARD_INITIALS#</span></span></div>',
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(921304102659437)
,p_theme_id=>42
,p_name=>'Vista'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(921710840659438)
,p_theme_id=>42
,p_name=>'Vita'
,p_is_current=>true
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(922063026659438)
,p_theme_id=>42
,p_name=>'Vita - Red'
,p_is_current=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(922502778659438)
,p_theme_id=>42
,p_name=>'Vita - Slate'
,p_is_current=>false
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1000799539659506)
,p_theme_id=>42
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1001192278659507)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1001535940659507)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1001939853659507)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1002349790659508)
,p_theme_id=>42
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1002798666659508)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1003196128659508)
,p_theme_id=>42
,p_name=>'SPACING_TOP'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1003627423659508)
,p_theme_id=>42
,p_name=>'STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1003983730659508)
,p_theme_id=>42
,p_name=>'TYPE'
,p_display_name=>'Type'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1004349985659509)
,p_theme_id=>42
,p_name=>'WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1004830458659509)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1005212928659509)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1005587321659509)
,p_theme_id=>42
,p_name=>'BADGE_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1005940045659511)
,p_theme_id=>42
,p_name=>'BODY_TEXT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1006424174659511)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1006745164659511)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1007224827659512)
,p_theme_id=>42
,p_name=>'ICONS'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1007574178659512)
,p_theme_id=>42
,p_name=>'ICON_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1008010607659512)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1008392504659512)
,p_theme_id=>42
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1008808240659512)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>1
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1009201812659513)
,p_theme_id=>42
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1009573908659513)
,p_theme_id=>42
,p_name=>'ACCENT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1010012038659513)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1010378765659513)
,p_theme_id=>42
,p_name=>'ALERT_ICONS'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1010754792659514)
,p_theme_id=>42
,p_name=>'ALERT_TYPE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1011184872659514)
,p_theme_id=>42
,p_name=>'ANIMATION'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1011599487659514)
,p_theme_id=>42
,p_name=>'BODY_HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1011985040659514)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1012391162659515)
,p_theme_id=>42
,p_name=>'BODY_PADDING'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1012796718659515)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1013165415659515)
,p_theme_id=>42
,p_name=>'DIALOG_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1013618240659516)
,p_theme_id=>42
,p_name=>'DISPLAY_ICON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1013942913659516)
,p_theme_id=>42
,p_name=>'HEADER'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1014361630659516)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1014781057659516)
,p_theme_id=>42
,p_name=>'ITEM_PADDING'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1015221316659516)
,p_theme_id=>42
,p_name=>'ITEM_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1015554314659517)
,p_theme_id=>42
,p_name=>'ITEM_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1015945692659517)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1016374386659517)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1016776058659517)
,p_theme_id=>42
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1017196618659518)
,p_theme_id=>42
,p_name=>'REGION_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1017583062659518)
,p_theme_id=>42
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>40
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1018013159659519)
,p_theme_id=>42
,p_name=>'TABS_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1018356504659520)
,p_theme_id=>42
,p_name=>'TAB_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1018778731659520)
,p_theme_id=>42
,p_name=>'TIMER'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1019170802659520)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1019541928659520)
,p_theme_id=>42
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1019974023659521)
,p_theme_id=>42
,p_name=>'BODY_TEXT'
,p_display_name=>'Body Text'
,p_display_sequence=>40
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1020339642659521)
,p_theme_id=>42
,p_name=>'COLOR_ACCENTS'
,p_display_name=>'Color Accents'
,p_display_sequence=>50
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1020763451659521)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1021220835659521)
,p_theme_id=>42
,p_name=>'ICONS'
,p_display_name=>'Icons'
,p_display_sequence=>20
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1021605832659522)
,p_theme_id=>42
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1021990178659522)
,p_theme_id=>42
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>30
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1022359077659522)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1022778194659522)
,p_theme_id=>42
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(1023201542659523)
,p_theme_id=>42
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1031666134659535)
,p_theme_id=>42
,p_name=>'DANGER'
,p_display_name=>'Danger'
,p_display_sequence=>30
,p_css_classes=>'t-Button--danger'
,p_group_id=>wwv_flow_api.id(1003983730659508)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1032394491659537)
,p_theme_id=>42
,p_name=>'LARGEBOTTOMMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapBottom'
,p_group_id=>wwv_flow_api.id(1001939853659507)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1033111565659537)
,p_theme_id=>42
,p_name=>'LARGELEFTMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapLeft'
,p_group_id=>wwv_flow_api.id(1002349790659508)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1033815441659538)
,p_theme_id=>42
,p_name=>'LARGERIGHTMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapRight'
,p_group_id=>wwv_flow_api.id(1002798666659508)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1034462969659539)
,p_theme_id=>42
,p_name=>'LARGETOPMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapTop'
,p_group_id=>wwv_flow_api.id(1003196128659508)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1035140082659540)
,p_theme_id=>42
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>30
,p_css_classes=>'t-Button--large'
,p_group_id=>wwv_flow_api.id(1001535940659507)
,p_template_types=>'BUTTON'
,p_help_text=>'A large button.'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1035865948659541)
,p_theme_id=>42
,p_name=>'DISPLAY_AS_LINK'
,p_display_name=>'Display as Link'
,p_display_sequence=>30
,p_css_classes=>'t-Button--link'
,p_group_id=>wwv_flow_api.id(1003627423659508)
,p_template_types=>'BUTTON'
,p_help_text=>'This option makes the button appear as a text link.'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1036539232659542)
,p_theme_id=>42
,p_name=>'NOUI'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1037305556659543)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1037941119659543)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1038658220659544)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1039349841659544)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1040062722659545)
,p_theme_id=>42
,p_name=>'PILL'
,p_display_name=>'Inner Button'
,p_display_sequence=>20
,p_css_classes=>'t-Button--pill'
,p_group_id=>wwv_flow_api.id(1000799539659506)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1040833344659545)
,p_theme_id=>42
,p_name=>'PILLEND'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1041513435659546)
,p_theme_id=>42
,p_name=>'PILLSTART'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1042171462659547)
,p_theme_id=>42
,p_name=>'PRIMARY'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1042918464659547)
,p_theme_id=>42
,p_name=>'SIMPLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1043588521659548)
,p_theme_id=>42
,p_name=>'SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1044299047659548)
,p_theme_id=>42
,p_name=>'STRETCH'
,p_display_name=>'Stretch'
,p_display_sequence=>10
,p_css_classes=>'t-Button--stretch'
,p_group_id=>wwv_flow_api.id(1004349985659509)
,p_template_types=>'BUTTON'
,p_help_text=>'Stretches button to fill container'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1044968358659549)
,p_theme_id=>42
,p_name=>'SUCCESS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1045705747659549)
,p_theme_id=>42
,p_name=>'TINY'
,p_display_name=>'Tiny'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1046420646659550)
,p_theme_id=>42
,p_name=>'WARNING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1047088251659550)
,p_theme_id=>42
,p_name=>'SHOWFORMLABELSABOVE'
,p_display_name=>'Show Form Labels Above'
,p_display_sequence=>10
,p_css_classes=>'t-Form--labelsAbove'
,p_group_id=>wwv_flow_api.id(1016374386659517)
,p_template_types=>'REGION'
,p_help_text=>'Show form labels above input fields.'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1047802756659551)
,p_theme_id=>42
,p_name=>'FORMSIZELARGE'
,p_display_name=>'Large'
,p_display_sequence=>10
,p_css_classes=>'t-Form--large'
,p_group_id=>wwv_flow_api.id(1015221316659516)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1048462486659551)
,p_theme_id=>42
,p_name=>'FORMLEFTLABELS'
,p_display_name=>'Left'
,p_display_sequence=>20
,p_css_classes=>'t-Form--leftLabels'
,p_group_id=>wwv_flow_api.id(1015945692659517)
,p_template_types=>'REGION'
,p_help_text=>'Align form labels to left.'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1049215205659552)
,p_theme_id=>42
,p_name=>'FORMREMOVEPADDING'
,p_display_name=>'Remove Padding'
,p_display_sequence=>20
,p_css_classes=>'t-Form--noPadding'
,p_group_id=>wwv_flow_api.id(1014781057659516)
,p_template_types=>'REGION'
,p_help_text=>'Removes padding between items.'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1049891370659552)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1050560250659553)
,p_theme_id=>42
,p_name=>'STRETCH_FORM_FIELDS'
,p_display_name=>'Stretch Form Fields'
,p_display_sequence=>10
,p_css_classes=>'t-Form--stretchInputs'
,p_group_id=>wwv_flow_api.id(1015554314659517)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1051251959659554)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1051999198659554)
,p_theme_id=>42
,p_name=>'LARGE_FIELD'
,p_display_name=>'Large'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--large'
,p_group_id=>wwv_flow_api.id(1005212928659509)
,p_template_types=>'FIELD'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1052371428659554)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1053047988659555)
,p_theme_id=>42
,p_name=>'X_LARGE_SIZE'
,p_display_name=>'X Large'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1089462031659686)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1107174997659724)
,p_theme_id=>42
,p_name=>'STRETCH_TO_FIT_WINDOW'
,p_display_name=>'Stretch to Fit Window'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1148809381659912)
,p_theme_id=>42
,p_name=>'FEATURED'
,p_display_name=>'Featured'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_api.id(37745726503902464)
,p_css_classes=>'t-HeroRegion--featured'
,p_group_id=>wwv_flow_api.id(1017583062659518)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1149517010659912)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_api.id(1013618240659516)
,p_template_types=>'REGION'
,p_help_text=>'Hide the Hero Region icon.'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1150149249659913)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1153604688659947)
,p_theme_id=>42
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1161419267660015)
,p_theme_id=>42
,p_name=>'TEXT_CONTENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1191258130660206)
,p_theme_id=>42
,p_name=>'JS_AUTO_HEIGHT'
,p_display_name=>'Dynamic Height'
,p_display_sequence=>5
,p_list_template_id=>wwv_flow_api.id(37777536670902488)
,p_css_classes=>'js-autoHeight'
,p_group_id=>wwv_flow_api.id(1005940045659511)
,p_template_types=>'LIST'
,p_help_text=>'This option will automatically size all cards so they share the same height and all the text is displayed.'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1228608389660487)
,p_theme_id=>42
,p_name=>'JS_AUTO_HEIGHT'
,p_display_name=>'Dynamic Height'
,p_display_sequence=>5
...
,p_css_classes=>'js-autoHeight'
,p_group_id=>wwv_flow_api.id(1019974023659521)
,p_template_types=>'REPORT'
,p_help_text=>'This option will automatically size all cards so they share the same height and all the text is displayed.'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1010754792659514)
,p_template_types=>'REGION'
...
,p_group_id=>wwv_flow_api.id(1010378765659513)
,p_template_types=>'REGION'
...
,p_group_id=>wwv_flow_api.id(1010012038659513)
,p_template_types=>'REGION'
...
,p_group_id=>wwv_flow_api.id(1012391162659515)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1018778731659520)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1011599487659514)
,p_template_types=>'REGION'
...
,p_group_id=>wwv_flow_api.id(1009573908659513)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1013942913659516)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1011985040659514)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1011184872659514)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1012796718659515)
,p_template_types=>'REGION'
);
end;
/
...
,p_group_id=>wwv_flow_api.id(1013165415659515)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1016776058659517)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1018356504659520)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1018013159659519)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1017196618659518)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1014361630659516)
,p_template_types=>'REGION'
...
,p_group_id=>wwv_flow_api.id(1019541928659520)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1021990178659522)
,p_template_types=>'REPORT'
...
,p_group_id=>wwv_flow_api.id(1023201542659523)
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1021220835659521)
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1020339642659521)
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1020763451659521)
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1019170802659520)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1022778194659522)
,p_template_types=>'REPORT'
...
,p_group_id=>wwv_flow_api.id(1022359077659522)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1021605832659522)
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
...
,p_css_classes=>'t-BadgeList--cols'
,p_group_id=>wwv_flow_api.id(1008392504659512)
,p_template_types=>'LIST'
,p_help_text=>'Arrange badges in a two column grid'
,p_is_advanced=>'N'
);
...
,p_list_template_id=>wwv_flow_api.id(37774128276902485)
,p_css_classes=>'t-BadgeList--large'
,p_group_id=>wwv_flow_api.id(1005587321659509)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_list_template_id=>wwv_flow_api.id(37777536670902488)
,p_css_classes=>'t-Cards--basic'
,p_group_id=>wwv_flow_api.id(1009201812659513)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
...
,p_list_template_id=>wwv_flow_api.id(37777536670902488)
,p_css_classes=>'t-Cards--displayIcons'
,p_group_id=>wwv_flow_api.id(1007224827659512)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
...
,p_list_template_id=>wwv_flow_api.id(37777536670902488)
,p_css_classes=>'u-colors'
,p_group_id=>wwv_flow_api.id(1006424174659511)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1006745164659511)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1008808240659512)
,p_template_types=>'LIST'
...
,p_group_id=>wwv_flow_api.id(1008010607659512)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_group_id=>wwv_flow_api.id(1001192278659507)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
...
,p_last_upd_yyyymmddhh24miss=>'20160628192456'
);
...
'      ,last_updated_by',
'      ,last_updated_dt AS last_updated_date',
'FROM   events_vw',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47847486331605908)
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'TITLE:DESCRIPTION:HOST_NAME:VENUE:REPEAT_TYPE:START_DT:END_DT:LAST_UPDATED_DATE:LAST_UPDATED_BY::VENUE_ID'
,p_sort_column_1=>'START_DATE'
,p_sort_direction_1=>'ASC'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(47685519701631622)
,p_application_user=>'JEFF'
,p_name=>'Pivot by Type'
,p_report_seq=>10
,p_report_type=>'PIVOT'
,p_report_alias=>'476856'
,p_status=>'PUBLIC'
,p_is_default=>'N'
,p_display_rows=>15
,p_report_columns=>'TITLE:HOST_NAME:EVENT_TYPE_NAME:DESCRIPTION:VENUE:CREATED_DATE:CREATED_BY:LAST_UPDATED_DATE:LAST_UPDATED_BY'
,p_sort_column_1=>'START_DATE'
,p_sort_direction_1=>'DESC'
,p_break_on=>'EVENT_TYPE_NAME'
,p_break_enabled_on=>'EVENT_TYPE_NAME'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_worksheet_pivot(
 p_id=>wwv_flow_api.id(47685986702631630)
,p_report_id=>wwv_flow_api.id(47685519701631622)
,p_pivot_columns=>'EVENT_TYPE_NAME'
,p_row_columns=>'HOST_NAME'
);
wwv_flow_api.create_worksheet_pivot_agg(
 p_id=>wwv_flow_api.id(47686367956631630)
,p_pivot_id=>wwv_flow_api.id(47685986702631630)
,p_display_seq=>1
...
wwv_flow_api.create_worksheet_pivot_sort(
 p_id=>wwv_flow_api.id(47686779186631631)
,p_pivot_id=>wwv_flow_api.id(47685986702631630)
,p_sort_seq=>1
,p_sort_column_name=>'APXWS_PV1'
,p_sort_direction=>'ASC'
);
wwv_flow_api.create_worksheet_pivot_sort(
 p_id=>wwv_flow_api.id(47687172409631632)
,p_pivot_id=>wwv_flow_api.id(47685986702631630)
,p_sort_seq=>2
,p_sort_column_name=>'APXWS_PV2'
,p_sort_direction=>'ASC'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160629151342'
);
wwv_flow_api.create_page_plug(
...
,p_plug_read_only_when=>'NOT APEX_AUTHORIZATION.is_authorized(''Operator'')'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
);
...
'      ,event_type AS return_value ',
'FROM   event_types_vw',
'WHERE  event_type = :P2_EVENT_TYPE OR active_ind = ''Y''',
'ORDER BY 1'))
,p_field_template=>wwv_flow_api.id(37790866266902497)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
,p_process_name=>'load'
,p_process_sql_clob=>'EVENTS$APEX.load;'
...
,p_process_sql_clob=>'EVENTS$APEX.process;'
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFFREY.KEMP@JK64.COM'
,p_last_upd_yyyymmddhh24miss=>'20160629124819'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(64757983657907612)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(64758193060907612)
,p_name=>'Event Types'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'JEFF'
,p_internal_uid=>27050831502019462
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758278739907620)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758374335907620)
,p_db_column_name=>'EVENT_TYPE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Code'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'EVENT_TYPE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758488963907620)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758581693907621)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758664318907621)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758775427907621)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Created By'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758892861907621)
,p_db_column_name=>'CREATED_DATE'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Created'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64758986445907622)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Last Updated By'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64759081078907622)
,p_db_column_name=>'LAST_UPDATED_DATE'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Last Updated'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(36726933857648432)
,p_db_column_name=>'CALENDAR_CSS'
,p_display_order=>19
,p_column_identifier=>'J'
,p_column_label=>'Calendar css'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(64766089577759054)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'270588'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NAME:EVENT_TYPE:CALENDAR_CSS:START_DATE:END_DATE:LAST_UPDATED_DATE:LAST_UPDATED_BY:'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64759272715907622)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(64757983657907612)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66990590238130022)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(64757983657907612)
,p_button_name=>'TABULAR_FORM'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
,p_button_image_alt=>'Tabular Form'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:RP,7::'
,p_icon_css_classes=>'fa-table'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(472966456930004)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(64757983657907612)
...
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
,p_button_image_alt=>'Interactive Grid'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:RP,15::'
,p_icon_css_classes=>'fa-table'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(27567451839966124)
,p_name=>'dialog closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(64757983657907612)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(27567530166966125)
,p_event_id=>wwv_flow_api.id(27567451839966124)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(64757983657907612)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
'});'))
,p_inline_css=>'.uppercase {text-transform:uppercase}'
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_api.id(62246532293840626)
,p_dialog_height=>'520'
,p_dialog_width=>'700'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160218094938'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(64753981242907575)
,p_plug_name=>'Event Type'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody:t-Form--large:t-Form--leftLabels'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37749289366902466)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(64762175838613126)
,p_plug_name=>'Record'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noUI:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37749289366902466)
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P4_VERSION_ID'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64754179506907576)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(64753981242907575)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
...
,p_button_condition=>'P4_VERSION_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
,p_icon_css_classes=>'fa-check'
,p_grid_new_grid=>false
,p_database_action=>'INSERT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64754393094907577)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(64753981242907575)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64761091276918850)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(64753981242907575)
,p_button_name=>'SAVE_COPY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64754275895907577)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(64753981242907575)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(64766967256826439)
,p_branch_action=>'f?p=&APP_ID.:4:&SESSION.:COPY:&DEBUG.::P4_COPY_ROWID:&P4_ROWID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(64761091276918850)
,p_branch_sequence=>5
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(64755177306907585)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36727081512648433)
,p_name=>'P4_CALENDAR_CSS'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(64753981242907575)
,p_prompt=>'Calendar Style'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'CALENDAR CSS'
,p_lov=>'.'||wwv_flow_api.id(47865337930471093)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(37790697573902496)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47847148627605905)
,p_name=>'P4_COPY_ROWID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(64753981242907575)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64755378816907588)
,p_name=>'P4_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(64753981242907575)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64755586657907596)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64755765654907598)
,p_name=>'P4_NAME'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(64753981242907575)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64755971740907599)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64756182226907599)
,p_name=>'P4_END_DATE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(64753981242907575)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64762364517613131)
,p_name=>'P4_CREATED_BY'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(64762175838613126)
,p_prompt=>'By'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(37790697573902496)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64762575799613132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64762776748613132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64762982281613132)
,p_name=>'P4_LAST_UPDATED_DT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(64762175838613126)
,p_prompt=>'Last Updated'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64763177983613133)
,p_name=>'P4_VERSION_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(64762175838613126)
,p_display_as=>'NATIVE_HIDDEN'
,p_help_text=>'No help available for this page item.'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(64765466671750747)
,p_validation_name=>'val'
,p_validation_sequence=>10
,p_validation=>'EVENT_TYPES$APEX.val;'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(65837174264199377)
,p_name=>'suggest event type'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
,p_bind_event_type=>'change'
,p_display_when_type=>'ITEM_IS_NULL'
,p_display_when_cond=>'P4_ROWID'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(65837480571199380)
,p_event_id=>wwv_flow_api.id(65837174264199377)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P4_EVENT_TYPE'
,p_attribute_01=>'JAVASCRIPT_EXPRESSION'
,p_attribute_05=>'$v("P4_NAME").toUpperCase().replace(/ /g,"_").replace(/:/g,"_")'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(64765176979745968)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'load'
,p_process_sql_clob=>'EVENT_TYPES$APEX.load;'
,p_process_error_message=>'#SQLERRM_TEXT#'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(64765571223753786)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'process'
,p_process_sql_clob=>'EVENT_TYPES$APEX.process;'
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27567397979966123)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'close dialog'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160403150321'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66953881501165621)
,p_plug_name=>'Hosts'
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37748115288902466)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(66954075347165621)
,p_name=>'Hosts'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_show_calendar=>'N'
,p_download_formats=>'CSV'
,p_detail_link=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.::P6_HOST_ID:#HOST_ID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
,p_owner=>'JEFF'
,p_internal_uid=>29246713788277471
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66954182890165625)
,p_db_column_name=>'HOST_ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Host Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66954279374165627)
,p_db_column_name=>'NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Host'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66954376026165627)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Created By'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66954485903165627)
,p_db_column_name=>'CREATED_DATE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Created'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66954594156165628)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Last Updated By'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66954673408165628)
,p_db_column_name=>'LAST_UPDATED_DATE'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Last Updated'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47848881838605922)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(66962072810238444)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'292548'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NAME:COUNT_EVENTS:LAST_UPDATED_DATE:LAST_UPDATED_BY:'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66954886114165628)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(66953881501165621)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60153616604867452)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(66953881501165621)
,p_button_name=>'GRID_EDIT'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(27567712479966127)
,p_name=>'dialog closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(66953881501165621)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(27567875458966128)
,p_event_id=>wwv_flow_api.id(27567712479966127)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(66953881501165621)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160218094913'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66950863822165591)
,p_plug_name=>'Host'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody:t-Form--large:t-Form--stretchInputs:t-Form--leftLabels'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37749289366902466)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66956762458188161)
,p_plug_name=>'Record'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noUI:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37749289366902466)
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P6_VERSION_ID'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66951077749165594)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(66950863822165591)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
...
,p_button_image_alt=>'Create'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'P6_VERSION_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
,p_icon_css_classes=>'fa-check'
,p_grid_new_grid=>false
,p_security_scheme=>wwv_flow_api.id(62246739341844416)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(56222910459244001)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(66950863822165591)
,p_button_name=>'SAVE_COPY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66951284576165594)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(66950863822165591)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66951181957165594)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(66950863822165591)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(56223032284244002)
,p_branch_name=>'Go To Page 6'
,p_branch_action=>'f?p=&APP_ID.:6:&SESSION.:COPY:&DEBUG.:RP,6:P6_COPY_HOST_ID:&P6_HOST_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(56222910459244001)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(66952071157165597)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47847068216605904)
,p_name=>'P6_COPY_HOST_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(66950863822165591)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66952289857165598)
,p_name=>'P6_HOST_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(66950863822165591)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66952488946165607)
,p_name=>'P6_NAME'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(66950863822165591)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66956989697188164)
,p_name=>'P6_CREATED_BY'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(66956762458188161)
,p_prompt=>'By'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(37790697573902496)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66957181832188164)
,p_name=>'P6_CREATED_DT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(66956762458188161)
,p_prompt=>'Created'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66957375989188165)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66957569043188165)
,p_name=>'P6_LAST_UPDATED_DT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(66956762458188161)
,p_prompt=>'Last Updated'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66957793826188165)
,p_name=>'P6_VERSION_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(66956762458188161)
,p_display_as=>'NATIVE_HIDDEN'
,p_help_text=>'No help available for this page item.'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(66958567804193936)
,p_validation_name=>'val'
,p_validation_sequence=>10
,p_validation=>'HOSTS$APEX.val;'
,p_validation_type=>'PLSQL_ERROR'
,p_error_message=>'null'
,p_always_execute=>'N'
,p_validation_condition_type=>'NOT_DISPLAYING_INLINE_VALIDATION_ERRORS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66958271808190858)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'load'
,p_process_sql_clob=>'HOSTS$APEX.load;'
,p_process_error_message=>'#SQLERRM_TEXT#'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66958689816195995)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'process'
,p_process_sql_clob=>'HOSTS$APEX.process;'
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27567634814966126)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'close dialog'
...
wwv_flow_api.create_page(
 p_id=>7
,p_user_interface_id=>wwv_flow_api.id(59324280286023993)
,p_name=>'Event Types Grid Edit'
,p_page_mode=>'NORMAL'
,p_step_title=>'Event Types Grid Edit'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
...
'  $("select[name=''f06''] option[value^=''apex-cal-'']")',
'    .each(',
'      function() {',
'        $(this).css({''background'' : $(this).val().substr(9)})',
'      }',
'    );',
'}'))
,p_javascript_code_onload=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160218092725'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(66986692447120714)
,p_name=>'Event Types'
,p_region_name=>'event_types'
,p_template=>wwv_flow_api.id(37749289366902466)
,p_display_sequence=>15
,p_include_in_reg_disp_sel_yn=>'N'
...
'      ,t.start_date',
'      ,t.end_date',
'      ,t.last_updated_dt AS last_updated_date',
'      ,t.version_id',
'      ,t.ROWID AS p_rowid',
'FROM   event_types t'))
...
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(37767321981902479)
,p_query_num_rows=>10
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66987066130120720)
,p_query_column_id=>1
...
,p_display_as=>'TEXT'
,p_column_width=>16
,p_css_classes=>'uppercase'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'EVENT_TYPES'
,p_ref_column_name=>'EVENT_TYPE'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66987186628120720)
,p_query_column_id=>2
,p_column_alias=>'NAME'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(36727187411648434)
,p_query_column_id=>3
,p_column_alias=>'CALENDAR_CSS'
,p_column_display_sequence=>4
,p_column_heading=>'Calendar Style'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_display_as=>'SELECT_LIST_FROM_LOV'
,p_named_lov=>wwv_flow_api.id(47865337930471093)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66987281614120720)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66987381509120720)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66987472450120720)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66987577191120720)
,p_query_column_id=>7
...
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'EVENT_TYPES'
,p_ref_column_name=>'VERSION_ID'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(47850271532605936)
,p_query_column_id=>8
,p_column_alias=>'P_ROWID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66989862917120734)
,p_query_column_id=>9
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66990262723120736)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37756253337902470)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66987981712120725)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(66986692447120714)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66987693628120725)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(66986692447120714)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66987884829120725)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(66986692447120714)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66987790131120725)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(66986692447120714)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(66989965425120734)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(66992179661173128)
,p_tabular_form_region_id=>wwv_flow_api.id(66986692447120714)
,p_validation_name=>'val_row'
,p_validation_sequence=>60
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'EVENT_TYPES$APEX.val_row (rv => ',
'  EVENT_TYPES$TAPI.rv ',
'    (rowid        => :P_ROWID',
...
'    ) ',
'  ,region_static_id => ''event_types''); ',
'RETURN null;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'err'
,p_always_execute=>'N'
,p_validation_condition_type=>'NOT_DISPLAYING_INLINE_VALIDATION_ERRORS'
,p_when_button_pressed=>wwv_flow_api.id(66987790131120725)
,p_exec_cond_for_each_row=>'Y'
,p_only_for_changed_rows=>'Y'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66997762767614091)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(66986692447120714)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'apply_mr'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'EVENT_TYPES$APEX.apply_mr (rv => ',
'  EVENT_TYPES$TAPI.rv ',
'    (rowid        => :P_ROWID',
'    ,event_type   => :EVENT_TYPE ',
'    ,name         => :NAME ',
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFFREY.KEMP@JK64.COM'
,p_last_upd_yyyymmddhh24miss=>'20160629121521'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160629151438'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57071763418444269)
,p_plug_name=>'Record'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noUI:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37749289366902466)
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P9_VERSION_ID'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
);
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47393458855294416)
,p_name=>'P9_EVENT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(47391499801294407)
,p_display_as=>'NATIVE_HIDDEN'
...
'      ,event_type AS return_value ',
'FROM   event_types_vw',
'WHERE  event_type = :P9_EVENT_TYPE OR active_ind = ''Y''',
'ORDER BY 1'))
,p_field_template=>wwv_flow_api.id(37790866266902497)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57072066585444277)
,p_name=>'P9_CREATED_DT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(57071763418444269)
,p_prompt=>'Created'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(37790697573902496)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57072453650444279)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57072884113444280)
,p_name=>'P9_LAST_UPDATED_DT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(57071763418444269)
,p_prompt=>'Last Updated'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57073213602444280)
,p_name=>'P9_LAST_UPDATED_BY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(57071763418444269)
,p_prompt=>'By'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57073660824444280)
,p_name=>'P9_VERSION_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(57071763418444269)
,p_display_as=>'NATIVE_HIDDEN'
,p_help_text=>'No help available for this page item.'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(47401591010294439)
,p_validation_name=>'val'
,p_validation_sequence=>10
,p_validation=>'EVENTS$APEX.val;'
,p_validation_type=>'PLSQL_ERROR'
,p_error_message=>'null'
,p_always_execute=>'N'
,p_validation_condition_type=>'NOT_DISPLAYING_INLINE_VALIDATION_ERRORS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47402244244294440)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'process'
...
wwv_flow_api.create_page(
 p_id=>10
,p_user_interface_id=>wwv_flow_api.id(59324280286023993)
,p_name=>'Hosts Grid Edit'
,p_page_mode=>'NORMAL'
,p_step_title=>'Hosts Grid Edit'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160218092848'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(60154160773876977)
,p_name=>'Hosts'
,p_region_name=>'hosts'
,p_template=>wwv_flow_api.id(37749289366902466)
,p_display_sequence=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(60154872216876983)
,p_query_column_id=>1
...
,p_pk_col_source=>'HOST_ID_SEQ'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'HOSTS'
,p_ref_column_name=>'HOST_ID'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(60155251178876990)
,p_query_column_id=>2
,p_column_alias=>'HOST_ID_DISPLAY'
,p_column_display_sequence=>3
,p_hidden_column=>'Y'
,p_derived_column=>'N'
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'HOSTS'
,p_ref_column_name=>'HOST_ID_DISPLAY'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(60155696706876990)
,p_query_column_id=>3
,p_column_alias=>'NAME'
,p_column_display_sequence=>4
,p_column_heading=>'Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(60157295005876991)
,p_query_column_id=>4
,p_column_alias=>'LAST_UPDATED_DT'
,p_column_display_sequence=>5
,p_column_heading=>'Last Updated'
,p_use_as_row_header=>'N'
,p_column_format=>'SINCE'
...
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'HOSTS'
,p_ref_column_name=>'LAST_UPDATED_DT'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(60157689798876992)
,p_query_column_id=>5
,p_column_alias=>'VERSION_ID'
,p_column_display_sequence=>6
,p_disable_sort_column=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(60165830025877017)
,p_query_column_id=>6
,p_column_alias=>'CHECK$01'
,p_column_display_sequence=>1
,p_column_heading=>'Select Row'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(60166741749877021)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37756253337902470)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60160799620876999)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(60154160773876977)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60160437020876999)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(60154160773876977)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60160692906876999)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(60154160773876977)
,p_button_name=>'MULTI_ROW_DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60160560248876999)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(60154160773876977)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60166243491877018)
,p_branch_action=>'f?p=&APP_ID.:10:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(60160560248876999)
,p_branch_sequence=>1
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(47847635434605910)
,p_tabular_form_region_id=>wwv_flow_api.id(60154160773876977)
,p_validation_name=>'val_row'
,p_validation_sequence=>10
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'HOSTS$APEX.val_row (rv =>',
'  HOSTS$TAPI.rv',
'    (host_id    => :HOST_ID',
'    ,name       => :NAME',
'    ,version_id => :VERSION_ID',
'    )',
'  ,region_static_id => ''hosts'');',
'RETURN null;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'null'
,p_always_execute=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47847741288605911)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(60154160773876977)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'apply_mr'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'HOSTS$APEX.apply_mr (rv =>',
'  HOSTS$TAPI.rv',
'    (host_id    => :HOST_ID',
'    ,name       => :NAME',
'    ,version_id => :VERSION_ID',
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160629150528'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160629150417'
);
wwv_flow_api.create_page_plug(
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P12_VERSION_ID'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
);
...
,p_button_image_alt=>'Copy'
,p_button_position=>'TOP'
,p_button_condition=>'P12_VERSION_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_icon_css_classes=>'fa-copy'
,p_grid_new_grid=>false
,p_security_scheme=>wwv_flow_api.id(62246739341844416)
...
,p_branch_action=>'f?p=&APP_ID.:12:&SESSION.:COPY:&DEBUG.:RP,12:P12_COPY_VENUE_ID:&P12_VENUE_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47849534661605929)
,p_name=>'P12_COPY_VENUE_ID'
,p_item_sequence=>20
...
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'load'
,p_process_sql_clob=>'VENUES$APEX.load;'
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
...
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'process'
,p_process_sql_clob=>'VENUES$APEX.process;'
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160629150637'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(61191910042195061)
,p_name=>'Venues'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(61192696685195066)
,p_query_column_id=>1
...
,p_display_as=>'HIDDEN'
,p_pk_col_source_type=>'S'
,p_pk_col_source=>'VENUE_ID_SEQ'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'VENUES'
,p_ref_column_name=>'VENUE_ID'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(61193063851195075)
,p_query_column_id=>2
,p_column_alias=>'VENUE_ID_DISPLAY'
,p_column_display_sequence=>3
,p_hidden_column=>'Y'
,p_derived_column=>'N'
,p_ref_schema=>'SAMPLE'
,p_ref_table_name=>'VENUES'
,p_ref_column_name=>'VENUE_ID_DISPLAY'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(61193459168195075)
,p_query_column_id=>3
,p_column_alias=>'NAME'
,p_column_display_sequence=>4
,p_column_heading=>'Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100820848628691403)
,p_query_column_id=>4
,p_column_alias=>'MAP_POSITION'
,p_column_display_sequence=>5
,p_column_heading=>'Map Position'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_display_as=>'TEXT'
,p_column_width=>40
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(61195050959195077)
,p_query_column_id=>5
,p_column_alias=>'LAST_UPDATED_DT'
,p_column_display_sequence=>6
,p_column_heading=>'Last Updated'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(61195400398195077)
,p_query_column_id=>6
,p_column_alias=>'VERSION_ID'
,p_column_display_sequence=>7
,p_disable_sort_column=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(61203141259195097)
,p_query_column_id=>7
,p_column_alias=>'CHECK$01'
,p_column_display_sequence=>1
,p_column_heading=>'Select Row'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(61204099227195098)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37756253337902470)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(61198423062195083)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(61191910042195061)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_api.id(37791266665902498)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(61198142497195083)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(61191910042195061)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(61198310232195083)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(61191910042195061)
,p_button_name=>'MULTI_ROW_DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(61198252109195083)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(61191910042195061)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(61203586625195097)
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(61198252109195083)
,p_branch_sequence=>1
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(47849124572605925)
,p_tabular_form_region_id=>wwv_flow_api.id(61191910042195061)
,p_validation_name=>'val_row'
,p_validation_sequence=>10
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47849279844605926)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(61191910042195061)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'apply_mr'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160628202446'
);
wwv_flow_api.create_page_plug(
...
'      ,e.venue_id',
'      ,(select min(x.name)',
'               keep (dense_rank last order by x.version_id)',
'        from   venues$jn x',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(99774635775529573)
,p_db_column_name=>'EVENT_TYPE'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Event Type'
...
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'EVENT_ID:VERSION_ID:JN$ACTION:EVENT_TYPE:TITLE:START_DT:END_DT:VENUE_NAME:HOST_NAME:JN$TIMESTAMP:'
...
wwv_flow_api.create_page(
 p_id=>15
,p_user_interface_id=>wwv_flow_api.id(59324280286023993)
,p_name=>'Event Types IG'
,p_page_mode=>'NORMAL'
,p_step_title=>'Event Types IG'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Event Types IG'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFFREY.KEMP@JK64.COM'
,p_last_upd_yyyymmddhh24miss=>'20160630023846'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(571410102191993546)
,p_plug_name=>'Event Types'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(471503989929989)
,p_name=>'ROWID'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(471550785929990)
,p_name=>'EVENT_TYPE'
,p_source_type=>'DB_COLUMN'
...
,p_attribute_05=>'BOTH'
,p_item_width=>30
,p_item_placeholder=>'Code'
,p_is_required=>true
,p_max_length=>100
,p_enable_filter=>true
,p_filter_operators=>'C:S:CASE_INSENSITIVE:REGEXP'
,p_filter_is_required=>true
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(471693460929991)
,p_name=>'NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(471760467929992)
,p_name=>'START_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(471892362929993)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(471936973929994)
,p_name=>'CALENDAR_CSS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(472520614929999)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(472573540930000)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(472894209930003)
,p_name=>'VERSION_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_interactive_grid(
 p_id=>wwv_flow_api.id(471360017929988)
,p_internal_uid=>506660125025090501
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'COLUMN'
,p_row_version_column=>'VERSION_ID'
...
wwv_flow_api.create_ig_report(
 p_id=>wwv_flow_api.id(477555852954512)
,p_interactive_grid_id=>wwv_flow_api.id(471360017929988)
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_api.create_ig_report_view(
 p_id=>wwv_flow_api.id(477729943954512)
,p_report_id=>wwv_flow_api.id(477555852954512)
,p_view_type=>'GRID'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(571411711220993557)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37756253337902470)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(473044869930005)
,p_tabular_form_region_id=>wwv_flow_api.id(571410102191993546)
,p_validation_name=>'val_row'
,p_validation_sequence=>10
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'RETURN EVENT_TYPES$TAPI.val (rv => ',
'  EVENT_TYPES$TAPI.rv ',
'    (event_type   => :EVENT_TYPE ',
'    ,name         => :NAME ',
'    ,calendar_css => :CALENDAR_CSS ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(470077619925540)
,p_name=>'dialog closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(571410102191993546)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(470543130925541)
,p_event_id=>wwv_flow_api.id(470077619925540)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(571410102191993546)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(473170337930006)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(571410102191993546)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>'process'
,p_attribute_01=>'PLSQL_CODE'
,p_attribute_04=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'EVENT_TYPES$APEX.apply_ig (rv =>',
'  EVENT_TYPES$TAPI.rv',
'    (rowid        => :ROWID',
'    ,event_type   => :EVENT_TYPE',
'    ,name         => :NAME',
...
,p_attribute_06=>'Y'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Interactive Grid process succeeded.'
);
end;
/
...
,p_name=>'Venues IG'
,p_page_mode=>'NORMAL'
,p_step_title=>'Venues IG'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Venues IG'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(571398392454365061)
,p_plug_name=>'Venues'
,p_region_name=>'venues'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(4025329141014989)
,p_name=>'VENUE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(4025449269014991)
,p_name=>'NAME'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'NAME'
,p_data_type=>'VARCHAR2'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(4025619749014992)
,p_name=>'MAP_POSITION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(4025812859014994)
,p_name=>'VERSION_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'VERSION_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(4025990391014996)
,p_name=>'APEX$ROW_ACTION'
,p_item_type=>'NATIVE_ROW_ACTION'
,p_label=>'Actions'
,p_heading_alignment=>'CENTER'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(4026068470014997)
,p_name=>'APEX$ROW_SELECTOR'
,p_item_type=>'NATIVE_ROW_SELECTOR'
,p_display_sequence=>10
,p_attribute_01=>'Y'
...
wwv_flow_api.create_interactive_grid(
 p_id=>wwv_flow_api.id(4025158405014988)
,p_internal_uid=>510213923412175501
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'COLUMN'
,p_row_version_column=>'VERSION_ID'
...
wwv_flow_api.create_ig_report(
 p_id=>wwv_flow_api.id(4034664346029054)
,p_interactive_grid_id=>wwv_flow_api.id(4025158405014988)
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
,p_settings_area_expanded=>true
...
wwv_flow_api.create_ig_report_view(
 p_id=>wwv_flow_api.id(4034794515029054)
,p_report_id=>wwv_flow_api.id(4034664346029054)
,p_view_type=>'GRID'
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
,p_edit_mode=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(571410581639365098)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(37756253337902470)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4024856731009596)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4026267279014999)
,p_tabular_form_region_id=>wwv_flow_api.id(571398392454365061)
,p_validation_name=>'val_row'
,p_validation_sequence=>10
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4026158849014998)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(571398392454365061)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>'Venues - Save Interactive Grid Data'
,p_attribute_01=>'PLSQL_CODE'
,p_attribute_04=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160218081655'
);
wwv_flow_api.create_page_plug(
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'JEFFREY.KEMP@JK64.COM'
,p_last_upd_yyyymmddhh24miss=>'20160629122030'
);
wwv_flow_api.create_page_plug(
